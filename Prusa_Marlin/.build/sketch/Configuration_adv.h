...
//#if ENABLED(FWRETRACT)
  ...
  #define RETRACT_RECOVER_LENGTH_SWAP -0.02   // Default additional swap recover length (mm, added to retract length when recovering from extruder change)
  #define RETRACT_RECOVER_FEEDRATE 80      // Default feedrate for recovering from retraction (mm/s)
  #define RETRACT_RECOVER_FEEDRATE_SWAP 80 // Default feedrate for recovering from swap retraction (mm/s)
//#endif
